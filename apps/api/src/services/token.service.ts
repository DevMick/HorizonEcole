...
interface TokenPayload {
  ...
  role: UserRole;
  /**
   * Établissement du compte. Il n'est pas la source d'autorité — le middleware
   * d'authentification relit l'établissement en base à chaque requête — mais il
   * évite une lecture supplémentaire côté client et documente le périmètre du
   * jeton.
   */

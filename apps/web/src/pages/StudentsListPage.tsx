...
export default function StudentsListPage() {
  ...
  const submitForm = async () => {
    try {
      ...
      // Absent au primaire, où le champ n'est pas affiché : l'API attribue
      // alors le matricule elle-même.
      if (values.studentNumber?.trim()) fd.append('studentNumber', values.studentNumber.trim());

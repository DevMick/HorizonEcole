    ...
    <div className="login-he">
      ...
      <div className="login-he-panel">
        ...
        <header className="login-he-header">
          {/* Logo et nom sur une seule ligne, comme dans l'en-tête du site. */}
          <div className="login-he-marque">
            <button
              type="button"
            ...
            >
              <img src={`${import.meta.env.BASE_URL}favicon-180.png`} alt="" width="52" height="52" />
            </button>
            <h1 className="login-he-title">
              <span className="login-he-title-ink">Horizon</span>
              <span className="login-he-title-ambre">Ecole</span>
            </h1>
          </div>
        ...
        <section className="login-he-card">
          ...
          {/* Entrée d'un nouvel établissement : l'application accueille
              plusieurs écoles, chacune configurée une fois. */}
          <p className="mt-4 text-center text-sm text-ds-text-secondary">
            Votre école n'est pas encore enregistrée ?{' '}
            <Link to="/creer-etablissement" className="font-medium text-role-primary underline">

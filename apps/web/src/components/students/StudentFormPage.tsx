 ...
 *
 * Le formulaire s'adapte au type d'établissement. Dans une école primaire,
 * quatre champs disparaissent parce qu'ils n'y ont pas de sens : le matricule
 * (le primaire n'en attribue pas — l'API en génère un), l'email et le contact
 * (un élève de CP1 n'en a pas, ce sont ceux de ses parents) et « affecté de
 * l'État » (notion propre à l'affectation en collège et lycée).
 *
 * La classe ne figure pas dans ce formulaire : un élève est d'abord une fiche
 * d'état civil, son affectation se décide à l'inscription (§ Inscriptions), et
    ...
    <div className="mx-auto max-w-3xl">
      ...
      <Card>
        <Form form={form} layout="vertical" preserve={false}>
          ...
          <Row gutter={16}>
            <Col span={isPrimary ? 24 : 12}><Form.Item name="gender" label="Genre" rules={[{ required: true, message: 'Genre requis' }]}><Select placeholder="Sélectionner"><Select.Option value="M">Masculin</Select.Option><Select.Option value="F">Féminin</Select.Option></Select></Form.Item></Col>
            {!isPrimary && (
